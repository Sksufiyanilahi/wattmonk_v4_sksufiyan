...
let NewdesignComponent = class NewdesignComponent {
    constructor(launchNavigator, datePipe, cdr, utils, storage, apiService, iab, storageservice, router) {
        this.launchNavigator = launchNavigator;
        this.datePipe = datePipe;
        this.cdr = cdr;
        this.utils = utils;
...
let DelievereddesignComponent = class DelievereddesignComponent {
    constructor(launchNavigator, datePipe, cdr, utils, storage, apiService, socialsharing, modalController, storageservice, router) {
        this.launchNavigator = launchNavigator;
        this.datePipe = datePipe;
        this.cdr = cdr;
        this.utils = utils;
...
let InreviewDesignComponent = class InreviewDesignComponent {
    constructor(launchNavigator, datePipe, cdr, utils, storage, apiService, storageservice, router) {
        this.launchNavigator = launchNavigator;
        this.datePipe = datePipe;
        this.cdr = cdr;
        this.utils = utils;
