...
export class PermitCompletedDesignComponent implements OnInit {
  ...
  iscompletepermit: boolean = false;
  ...
  constructor(private launchNavigator: LaunchNavigator,
      ...
      private apiService: ApiService,    private platform:Platform,

      private storageservice: StorageService,
      private router: Router,private eventService: CustomEventsService) {
