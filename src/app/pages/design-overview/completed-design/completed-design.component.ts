...
@Component({
  selector: 'app-completed-design',
  templateUrl: './completed-design.component.html',
  styleUrls: ['./completed-design.component.scss'],
})
...
export class CompletedDesignComponent implements OnInit {
  ...
  iscompletedesign: boolean = false;
