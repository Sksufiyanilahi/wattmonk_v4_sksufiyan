...
import { ADDRESSFORMAT, MAILFORMAT, NAME, COMPANYFORMAT, NUMBERPATTERN } from "src/app/services/constants";
...
export class DesignComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.desginForm = this.formBuilder.group({
            ...
            name: new FormControl('', [Validators.required,Validators.minLength(2), Validators.pattern(NAME)]),
            ...
            address: new FormControl('', [Validators.required, Validators.pattern(ADDRESSFORMAT),Validators.maxLength(300)]),
            ...
            requirmenttype: new FormControl('assessment'),
            ...
            prioritytoggle: new FormControl('false'),
    ...
    submitform() {
        if (this.desginForm.status === 'VALID') {
                ...
                if (this.send === ScheduleFormEvent.SAVE_DESIGN_FORM) {
                    ...
                    this.utils.showLoading('Saving').then(() => {
                        let data = {
                            ...
                            tiltofgroundmountingsystem: parseInt(this.desginForm.get('tiltofgroundmountingsystem').value),
                            ...
                            status: designstatus,
                            prioritytoggle:JSON.parse(this.desginForm.get("prioritytoggle").value),
                            ...
                            requirmenttype: this.desginForm.get('requirmenttype').value,
                            ...
                            dataentry: false,
                            isonpriority: false,
                            newinvertermade: null,
                            newinvertermake: null,
                            newmodulemade: null,
                            newmodulemake: null,
                            paymentstatus: null,
                            amount: null,
                    ...
                    let data = {
                        ...
                        projectsubtype: this.desginForm.get('propertysubtype').value,
                        designinverters: designinverters,
                        hashkey: "" + new Date().getTime() + "",// designinverters: [
                            recordidsf:"",
                            dataentry: false,
                            isonpriority: false,
                            newinvertermade: null,
            ...
            } else if (this.desginForm.value.comments == '') {
                this.utils.errorSnackBar('You must enter a value.');
            } else {

                console.log('arc',this.desginForm.get('architecturaldesign').value);
