...
@Component({
  selector: 'app-pestamp-details',
  templateUrl: './pestamp-details.component.html',
  styleUrls: ['./pestamp-details.component.scss'],
})


export class PestampDetailsComponent implements OnInit {
  ...
  constructor(private router: Router,
    ...
    this.userAccessRights = this.utilities.getUserAccessRights('pestamp');
  ...
  getDesignDetails() {
    ...
    this.utilities.showLoading('Getting Design Details').then((success) => {
      this.apiService.getPestampDetails(this.pestampdesignId).subscribe((result:any) => {
        this.utilities.hideLoading();
        console.log("result",result)
        //this.setData(result);
        //this.timer();
        this. pestampdesign = result.data.attributes;
        this.validations();
      }, (error) => {
        this.utilities.hideLoading();
      });
