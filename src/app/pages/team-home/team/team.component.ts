...
export class TeamComponent implements OnInit {
    ...
    data1={
        'details':[
        { name:"Shaikh Sufiyan ", email:"18ilahi@gmail.com",image:"../../../../assets/images/img1.svg"},
        { name:"Shaikh Sufiyan ", email:"18ilahi@gmail.com",image:"../../../../assets/images/img2.svg"},
        { name:"Shaikh Sufiyan ", email:"18ilahi@gmail.com",image:"../../../../assets/images/img1.svg"},
        { name:"Shaikh Sufiyan ", email:"18ilahi@gmail.com",image:"../../../../assets/images/img1.svg"},
        { name:"Shaikh Sufiyan ", email:"18ilahi@gmail.com",image:"../../../../assets/images/img2.svg"}
      ]
    ...
    getTeamData(event, showLoader: boolean) {
        ...
        this.apiService.getTeamData().subscribe((res) => {
            console.log("this is team data",res)
            this.isTeamData = true;
            this.send_counts();
            this.teamData = res;

            this.listOfteamData = res;
            console.log("this is list of team data",this.listOfteamData)
    ...
    teamScheduledPage() {
        ...
        // });
        this.route.navigate(['/team-schedule']);
