...
export class PermitComponent implements OnInit {
  ...
  segments:any="requesttype=permit&status=designassigned&status=designinprocess";
  ...
  segmentChanged(event){
     if(event.target.value=='InDesign'){
        this.segments ="requesttype=permit&status=designassigned&status=designinprocess";
