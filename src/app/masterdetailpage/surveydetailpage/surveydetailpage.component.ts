...
import { AlertController, NavController, ToastController, ModalController, IonSlides } from '@ionic/angular';
...
import { ModalPageComponent } from 'src/app/survey-detail/modal-page/modal-page.component';
import { User } from 'src/app/model/user.model';
import { PhotoViewer } from '@ionic-native/photo-viewer/ngx';
import { InAppBrowser } from '@ionic-native/in-app-browser/ngx';

@Component({
  selector: 'app-surveydetailpage',
  templateUrl: './surveydetailpage.component.html',
