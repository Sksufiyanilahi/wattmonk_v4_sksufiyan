...
@Component({
  selector: 'app-prelimdetailpage',
  templateUrl: './prelimdetailpage.component.html',
  styleUrls: ['./prelimdetailpage.component.scss'],
})
 ...
 // prelimFileType:any;
  ...
  getDesignDetails() {
    ...
    this.utilities.showLoading('Getting Design Details').then((success) => {
      this.apiService.getDesginDetail(this.prelimdesignId).subscribe((result) => {
