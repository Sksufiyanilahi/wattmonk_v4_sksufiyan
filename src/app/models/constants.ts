...
export const INVALID_PHONE_NUMBER = 'Phone number should be of min. 8 and max. 15 numbers.'
...
export const WHITESPACES = "Blank space in not allowed";

export const SELECT_SLOT = "Please select time slot";
